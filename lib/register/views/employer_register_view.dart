...
class _EmployerRegisterViewState extends State<EmployerRegisterView> {
  ...
  // Function to submit the form and store data in Firebase
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        DatabaseReference dbRef = FirebaseDatabase.instance.ref('employers');
        ...
        context.go('/login'); // Using go_router for navigation
